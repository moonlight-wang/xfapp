...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row11">
   <div class="x-col" xid="col22"><span xid="span11" class="pull-left" style="width:50%;">
   <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit1" style="width:95%;">
    <select component="$UI/system/components/justep/select/select" class="form-control pull-left x-edit" xid="select2" style="weigh:30%;height:333%;width:100%;">
     ...
     <option value="20" xid="default3">20小时</option></select> </div> </span>
  <span xid="span13" class="pull-left" style="width:50%;">
   <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit3" style="width:95%;">
    <select component="$UI/system/components/justep/select/select" class="form-control pull-left x-edit" xid="select3" style="weigh:30%;height:333%;width:100%;">
     ...
     <option value="50" xid="default5">50分钟</option></select> </div> </span></div>
   </div></div> </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row8"> 
        <div class="x-col" xid="col17" style="Text-align:center;"><a component="$UI/system/components/justep/button/button" class="btn btn-default btn-lg btn-only-icon" label="关机" xid="button10" icon="glyphicon glyphicon-off">
