...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:353px;top:1px;" onLoad="modelLoad">
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="listData" idColumn="sID" confirmRefresh="false">
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        ...
        <div class="x-titlebar-left" xid="left1"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" onClick="{'operation':'window.close'};" label="button" xid="button1" icon="icon-chevron-left" style="display:none;">
   ...
   <span xid="span2"></span></a></div>
    ...
    <div xid="content1" _xid="C6F5B0969BE00001D49313F012631710" style="bottom: 0px;" class="x-panel-content"> 
      
  <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full" active="0" xid="contents5">
   <div class="x-contents-content  x-scroll-view " xid="content6"><div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView" xid="scrollView1" onPullDown="modelLoad">
   ...
   <div class="x-scroll-content" xid="div2">
    <div component="$UI/system/components/justep/list/list" class="x-list x-cards" xid="list2" data="listData">
     <ul class="x-list-template list-group" xid="listTemplateUl2">
      <li xid="li2" class="list-group-item">
       <div xid="div25" bind-click="listClick" style="overflow:hidden;">
        ...
        <div xid="nextDiv" class="media-right">
         ...
         <div xid="div8">
          <div component="$UI/system/components/justep/output/output" class="x-output" xid="output3" bind-ref='ref("status")'></div></div> </div> </div> 
  <div class="x-swipe-area" xid="div27" bind-click="div27Click">删除</div></li> </ul> </div> </div> 
