  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   ...
   <div class="x-panel-content center-block" xid="content1" style="background-color:#8a8fef;">
    <div component="$UI/system/components/justep/row/row" class="x-row" xid="row5">
     ...
     <div class="x-col" style="Text-align:center;font-size:12px;" xid="col19" bind-text=' $model.valueData.val("state")'></div></div> 
      ...
      <div xid="div5">
       <div component="$UI/system/components/justep/row/row" class="x-row" xid="row7">
        ...
        <div class="x-col" style="Text-align:center;font-size:12px;" xid="col10">
         <div xid="div6" bind-text=' $model.valueData.val("weather")'></div>
         <div xid="div7" bind-text=' $model.valueData.val("temperature")'></div></div> </div> </div> </div> </div> 
    <div component="$UI/system/components/justep/row/row" class="x-row" xid="row11">
     <div class="x-col" xid="col25" style="Text-align:center;font-size:12px;">
      <div xid="div2" style="Text-align:center;font-size:12px;">
       <span xid="span9" bind-text='$model.valueData.ref("name")'></span>
    ...
    <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2">
     <div class="x-col" xid="col1" style="Text-align:center;">TVOC
      <div xid="div3">
       <br xid="default7"></br>
       <span xid="span12" bind-text='$model.nData.ref("TOVC")'></span></div> </div> 
     <div class="x-col" xid="col3" style="Text-align:center;">CO2
      <div xid="div8">
       <br xid="default8"></br>
       <span xid="span13" bind-text='$model.nData.ref("CO2")'></span></div> </div> </div> 
    <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
     ...
     <div class="x-col" xid="col5" style="Text-align:center;font-size:12px;">室内PM2.5
      <div xid="div9">
       <span xid="span14" bind-text='$model.nData.ref("nPM")' style="Text-align:center;font-size:30px;"></span></div> </div> 
